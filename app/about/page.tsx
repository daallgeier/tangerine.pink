...
const experiences = [
	...
	},
	{
		...
		description: "Through my Adventures as an athlete I am creating a lot of experiences I want to share with the world.  I want to inspire people to go out and explore the world.   Show them the beauty of the world and that we need to protect it. Teach people how to be concious and responsible, and how people can take action in their own workplaces to make a difference.  Showing people how to make cool stuff happen and make others follow.",
		startDate: "2023-10-01",
		endDate: "ongoing",
		isExternal: false,
	},
